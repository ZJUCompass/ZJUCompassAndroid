package com.zjucompass.zjucampus3.widget;
...
import com.zjucompass.zjucampus3.R;
import com.zjucompass.zjucampus3.Teacher;
...
public class ContactListAdapter extends ArrayAdapter<Teacher>
{
			...
			int position)
	{
		...
		TextView nameView = (TextView) infoView.findViewById(R.id.teacher_name);
